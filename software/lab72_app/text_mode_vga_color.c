...
void setColorPalette (alt_u8 color, alt_u8 red, alt_u8 green, alt_u8 blue)
{
	...
	vga_ctrl->palette[0] = 0xffffffff;
	vga_ctrl->palette[1] = 0xe6387823;
	vga_ctrl->palette[2] = 0x89829192;
	vga_ctrl->palette[3] = 0x12345678;
	//vga_ctrl->palette[0] =
...
void textVGAColorScreenSaver()
{
	...
	volatile int* data = (int*) (0x4000 + 0x800);
	data[0] = 0xFFFFFFF;
